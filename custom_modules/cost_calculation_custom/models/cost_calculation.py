...
class cost_calculation_custom_0(models.Model):
    ...
    def save_cost(self):
        ...
        is_purchase_montador = True if ((self.x_studio_obra == 'si' and self.x_studio_coste_montaje > 0) or self.x_studio_desmontar > 0 or self.x_studio_post_cuarzo > 0) else False
